    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (key.length() == 10 && key.matches("[01]+")) {
                ...
                System.out.println("Enter exactly 10 bits for key.");
            } else {
                System.out.println("Key must contain only 0 and 1.");
            }
        }
        ...
        while (true) {
            ...
            if (plaintext.length() == 8 && plaintext.matches("[01]+")) {
                ...
                System.out.println("Enter exactly 8 bits for plaintext.");
            } else {
                System.out.println("Plaintext must contain only 0 and 1.");
            }
        }
